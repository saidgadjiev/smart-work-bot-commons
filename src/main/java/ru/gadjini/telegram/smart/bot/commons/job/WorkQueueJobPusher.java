...
public abstract class WorkQueueJobPusher {
    ...
    private boolean heavyAtFirst;

    public WorkQueueJobPusher(boolean heavyAtFirst) {
        this.heavyAtFirst = heavyAtFirst;
